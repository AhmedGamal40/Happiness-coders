  ...
  return ( 
    <section className="portfolio--section" id="MyPortfolio" >
      <div className="portfolio--container-box">
        ...
        <div>
            <Link className="btn btn-github" target="_blank" to="https://www.upwork.com/freelancers/~01781dfd528e841859">
            <svg
    ...
    <div key={index} className="col-lg-4">
      ...
      <div className="card m-2">
              ...
              <Carousel.Item key={index}>
                ...
                <img src={src} className="d-block w-100" alt={`Image ${index + 1}`}/>
              </Carousel.Item>
              ))}
            </Carousel>
          <div className="card-body">
            <h5 className="card-title text-center "><mark className="bg-warning">{item.title}</mark></h5>
